#**** PARKING LOT FOR OLDER TAXIZE CODE in AvianInteractionData_L1.R

# Last used August 2024
# Nov 2024: now incorporated taxize roles into taxadb package use in AvianInteractionData_L1.R
# Nov 2024: moving int type code edits to separate script
# nov 2024: moving BBS int.raw selection to separate script



# The section below, using taxize (currently package is not updated/functioning), was last run on Aug 9, 2024.
tax <-gnr_datasources()
# GBIF taxonomy ID = 11
