...
## automatic checking if there is a change to source database GBIF,
...
write_table_entry(src_scientific == "Larus fuscus fuscus", target_scientific == "Larus fuscus fuscus", notes = "Keep original")
