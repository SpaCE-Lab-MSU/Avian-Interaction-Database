...
sp<-as.list(sp)
length(sp)
# 670 species1 as of Dec 11, 2023 (all double checked)
...
spir<-as.list(spir)
length(spir)
# 501 species1 as of Dec 11, 2023
...
# 974 unique species1 as of Dec 11, 2023 (these include some non-BBS species1)
