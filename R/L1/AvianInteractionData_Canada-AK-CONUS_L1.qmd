...
AvianInteractionData_L1_file <-  "AvianInteractionData_L1_20251216_plz.csv"
...
- Current selected species list for Canada/Alaska/CONUS =
 ...
 ( output via Working repo, from `R/L1/AvianInteractionData_specieslists_Canada_CONUS_L1.R` ) = splist_CanadaAKCONUS_L1.csv
...
```{r}
AvianInteractionData_CanadaAKCONUS_L1_file <- "AvianInteractionData_CanadaAKCONUS_L1_20251216_plz.csv"
AvianInteractionData_CanadaAKCONUS_breeding_file <- "AvianInteractionData_CanadaAKCONUS_breeding_L1_20251216_plz.csv"
AvianInteractionData_L1_not_CanadaAKCONUS_file <- 
  "AvianInteractionData_L1_not_CanadaAKCONUS_20251216_plz.csv"
...
current_species_list_filename <- "splist_CanadaAKCONUS_L1.csv"
...
```{r}
sort(unique(intxns.db.subset$interaction))
# List of characters to re-assign
old3 <- c("competition-foraging","competition-nest site","competition-territory")
new3 <- "competition"
# Re-assign values 
intxns.db.subset$interaction <- ifelse(intxns.db.subset$interaction %in% old3, new3, intxns.db.subset$interaction)
sort(unique(intxns.db.subset$interaction))
```
