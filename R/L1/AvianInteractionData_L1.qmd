...
AvianInteractionData_L0_file <-  "AvianInteractionData_L0_stitch_06oct25.csv"
...
- Current selected species list =
  ...
  `R/L0/AvianInteractionData_specieslists_Canada_CONUS_L1.R` (North America)
...
manual_taxonomic_resolutions_file_name<- here::here('R/L1', "manual_taxonomic_resolutions_L1_2025-10.csv")
```
...
AvianInteractionData_L1_taxonomy_table_file <- "AvianInteractionData_L1_taxonomy_resolutions.csv"
...
- AvianInteractionData_Canada-AK-CONUS_L1.qmd - this cleans further (e.g., breeding/non-breeding) and some of that needs to go in general cleaning (either here or in another script).
...
4. apply the edits in the file regardless if there is alread a note since 
...
for(r in 1:nrow(manual_taxonomic_resolutions)){
  ...
  if(length(matching_rows) == 0){
    ...
    int.raw.names.manual[matching_rows,]$scientific_name.edit <- manual.edit$scientific_name.raw
...
as possible
@Lucas/Kelly: 12/11/2025: This is not working. It does not re-assign edited names from raw (incorrect) names in manual_taxonomic_resolutions_L1_2025-10.csv. This may be why the Northwestern Crow issue continues to pop up.
...
11/6/2025: STILL NOT CHANGING Northwestern Crow to American Crow!!! I cannot figure this out. Hard-coding here.
```{r}
int.raw.resolved

int.raw.resolved$species1_scientific[int.raw.resolved$species1_common == "Northwestern Crow"] <- "Corvus brachyrhynchos"
int.raw.resolved$species1_common[int.raw.resolved$species1_common == "Northwestern Crow"] <- "American Crow"
int.raw.resolved$species2_scientific[int.raw.resolved$species2_common == "Northwestern Crow"] <- "Corvus brachyrhynchos"
int.raw.resolved$species2_common[int.raw.resolved$species2_common == "Northwestern Crow"] <- "American Crow"
...
print(length(unique(int.raw$interaction))) #36

print("unique pairwise interactions") #19417
